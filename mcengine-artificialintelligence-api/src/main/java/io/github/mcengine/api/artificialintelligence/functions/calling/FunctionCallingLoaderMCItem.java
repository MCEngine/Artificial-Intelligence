...
public class FunctionCallingLoaderMCItem {
    ...
    static {
        ...
        MATERIAL_ALIASES.put("{gold_ingot}", Material.GOLD_INGOT);
        MATERIAL_ALIASES.put("{iron_sword}", Material.IRON_SWORD);
        MATERIAL_ALIASES.put("{golden_apple}", Material.GOLDEN_APPLE);
        MATERIAL_ALIASES.put("{emerald}", Material.EMERALD);
        MATERIAL_ALIASES.put("{stone_pickaxe}", Material.STONE_PICKAXE);
        ...
        MATERIAL_ALIASES.put("{netherite_ingot}", Material.NETHERITE_INGOT);
